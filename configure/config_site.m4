...
dnl Four variables are only valid for ESS, in order to assign
dnl the CC toolchain dynamically.
dnl
ifdef(`_CC_IFC14XX_TOOLCHAIN_PATH',
	`CC_IFC14XX_TOOLCHAIN_PATH = _CC_IFC14XX_TOOLCHAIN_PATH',
	`CC_IFC14XX_TOOLCHAIN_PATH = ')
	
ifdef(`_CC_IFC14XX_TOOLCHAIN_VER',
	`CC_IFC14XX_TOOLCHAIN_VER = _CC_IFC14XX_TOOLCHAIN_VER',
	`CC_IFC14XX_TOOLCHAIN_VER = ')


ifdef(`_CC_POKY_TOOLCHAIN_PATH',
	`CC_POKY_TOOLCHAIN_PATH = _CC_POKY_TOOLCHAIN_PATH',
	`CC_POKY_TOOLCHAIN_PATH = ')
	
ifdef(`_CC_POKY_TOOLCHAIN_VER',
	`CC_POKY_TOOLCHAIN_VER = _CC_POKY_TOOLCHAIN_VER',
	`CC_POKY_TOOLCHAIN_VER = ')
