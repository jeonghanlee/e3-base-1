...
dnl Two variables are only valid for ESS, in order to assign
dnl the CC toolchain dynamically.
dnl
ifdef(`_CROSS_COMPILER_TOOLCHAIN_PATH',
	`CROSS_COMPILER_TOOLCHAIN_PATH = _CROSS_COMPILER_TOOLCHAIN_PATH',
	`CROSS_COMPILER_TOOLCHAIN_PATH = ')

ifdef(`_CROSS_COMPILER_TOOLCHAIN_VER',
	`CROSS_COMPILER_TOOLCHAIN_VER = _CROSS_COMPILER_TOOLCHAIN_VER',
	`CROSS_COMPILER_TOOLCHAIN_VER = ')
