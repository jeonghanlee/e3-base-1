...
dnl
ifdef(`_IFC14XX_CC_TOOLCHAIN_PATH',
	`IFC14XX_CC_TOOLCHAIN_PATH = _IFC14XX_CC_TOOLCHAIN_PATH',
	`IFC14XX_CC_TOOLCHAIN_PATH = ')
	
ifdef(`_IFC14XX_CC_TOOLCHAIN_VER',
	`IFC14XX_CC_TOOLCHAIN_VER = _IFC14XX_CC_TOOLCHAIN_VER',
	`IFC14XX_CC_TOOLCHAIN_VER = ')


ifdef(`_POKY_CC_TOOLCHAIN_PATH',
	`POKY_CC_TOOLCHAIN_PATH = _POKY_CC_TOOLCHAIN_PATH',
	`POKY_CC_TOOLCHAIN_PATH = ')
	
ifdef(`_POKY_CC_TOOLCHAIN_VER',
	`POKY_CC_TOOLCHAIN_VER = _POKY_CC_TOOLCHAIN_VER',
	`POKY_CC_TOOLCHAIN_VER = ')
